...
\todo{was heist das? was genau kann man lösen?}
...
\todo{wie funktioniert das? (lässt sich das beantworten)}
...
\begin{lstlisting}[frame=single,caption=Ubuntu Installation]
cd /vagrant
...
\paragraph{Calling Python from C}
...
\section{Vergleiche und Auswahl von Werkzeugen}
...
\section{Vorbereitungen für die Implementierung}
