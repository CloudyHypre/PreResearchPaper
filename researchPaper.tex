...
\todo{HYPRE genauer beschreiben}
\todo{HYPRE beispiel ex5}
...
\todo{was heist das? was genau kann man lösen?wie funktioniert das? (lässt sich das beantworten)}
\todo{wie löst sie die probleme (groben einblick in die funktionsweise der methoden, falls möglich)}

\paragraph{Performance}
Nutzt MPI für Parallelisierbarkeit.
...
//create smg (etc) mit anderem precond. 
\end{lstlisting}
...
\paragraph{Bibliotheken/Frameworks/Implementierungen}
...
\section{Beispielinstallation OpenStack}
...
\subsection{Vorbereitung für die Installation}
...
\subsection{Benutzung Beispielhaft}
...
\paragraph{Überblick Oberfläche und Funktionen erläutern}
